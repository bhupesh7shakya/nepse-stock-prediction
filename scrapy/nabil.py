...
Original file is located at
    https://colab.research.google.com/drive/1_ndoxGQThxcmV9q-6EsE5XOCuh5ZYcUS
"""
...
closing_price=df.ltp.str.replace(',', '').astype(float)
...
ma100ma100=closing_price.rolling(100).mean()
